...
export const ru: LangType = {
    ...
    'page.body.landing.marketInfo.title.text2': 'Buy, Sell and Trade Digital Currencies with "No Commission"',
    ...
    'page.body.landing.features.features.item1.text': 'PyhtonEx offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'PyhtonEx offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.footer.rights': 'PyhtonEx © All rights reserved.',
